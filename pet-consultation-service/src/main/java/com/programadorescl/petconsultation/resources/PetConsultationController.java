...
public class PetConsultationController {
    ...
    protected static final Logger logger = Logger.getLogger(PetConsultationController.class.getName());
    ...
    public ResponseEntity<PetConsultation> add(@RequestBody PetConsultationVO petConsultationVO) throws Exception {
        logger.info(String
                .format("pet-consultation-service add() invoked: %s for %s", petConsultationService.getClass().getName(),
                        petConsultationVO.getName()));
    ...
    public ResponseEntity<PetConsultation> update(@RequestBody PetConsultationVO petConsultationVO) throws Exception {
        logger.info(String
                .format("pet-consultation-service update() invoked: %s for %s", petConsultationService.getClass().getName(),
                        petConsultationVO.getName()));
        System.out.println(petConsultationVO);
        PetConsultation petConsultation = PetConsultation.getDummyPetConsultation();
        BeanUtils.copyProperties(petConsultationVO, petConsultation);
    ...
    public ResponseEntity<List<PetConsultation>> findALL() throws Exception {
        logger.info(String
                .format("pet-consultation-service findALL() invoked: %s for %s", petConsultationService.getClass().getName(),
                        "GETALL"));
    ...
    public ResponseEntity<PetConsultation> findByNationalRegistry(@PathVariable("nationalRegistry") String nationalRegistry) throws Exception {
        logger.info(String
                .format("pet-consultation-service findByProfessionalLicense() invoked: %s for %s", petConsultationService.getClass().getName(),
                        nationalRegistry));
    ...
    public ResponseEntity<PetConsultation> delete(@PathVariable("nationalRegistry") String nationalRegistry) throws Exception {
        logger.info(String
                .format("pet-consultation-service delete() invoked: %s for %s", petConsultationService.getClass().getName(),
                        nationalRegistry));
        try {
